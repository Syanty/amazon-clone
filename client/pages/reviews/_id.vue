  ...
  methods: {
    ...
    async onAddReview() {
      try {
        ...
        review.append("headline", this.headline),
          review.append("body", this.body),
          review.append("rating", this.rating),
          review.append("photo", this.selectedFile, this.selectedFile.name);
